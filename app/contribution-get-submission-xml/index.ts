...
const connectionString = "DefaultEndpointsProtocol=https;AccountName=sagscdevs01;AccountKey=L/FWrjIe2BDpxC9bViRhDokBuQot8Mb3d3ANDORpd6HTv+PHhRQL8p6xPsu+XGN6L5H7QCoFLus0+AStmPfApw==;EndpointSuffix=core.windows.net";
...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    const doc = await controller.generateXml(contribHeaderId);
    if (doc.length === 0) {
        context.res = {
