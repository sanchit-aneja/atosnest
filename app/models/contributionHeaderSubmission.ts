...
ContributionHeaderSubmission.addHook(
  "beforeValidate",
  (contributionheadersubmission, _options) => {
...
ContributionHeaderSubmission.beforeCreate(
  async (contributionheadersubmission, _options) => {
    const schema = Joi.object({
