/*
In >= 1 detail record, reason code 10 has been entered without the Member Contributions 
for Second Enrolment field being provided

*/
export const id31_11Response = {
  dataHeaderRow: {
  ...
  dataDetailRows: [
    {
      ...
      newGroupName: "fff",
      newGroupPensEarnings: "3.3",
      newGroupEmplContriAmt: "4",
      newGroupMembContriAmt: "5",
      optoutRefNum: true,
      optoutDeclarationFlag: true,
      newPaymentPlanNo: null,
      newPaymentSourceName: null,
      membNonPayEffDate: "2022-09-26",
      secEnrolPensEarnings: "2",
      secEnrolEmplContriAmt: "3",
