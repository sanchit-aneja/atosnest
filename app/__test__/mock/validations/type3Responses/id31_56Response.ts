/*
In >= 1 detail record, reason code 7 has been entered, the sum of the Employer Contribution + 
Member Contribution fields is >£0 and the date entered in the Effective Date of Group Change field
 is = EPSD of the CS the file is being uploaded for


*/

export const id31_56Response = {
  dataHeaderRow: {
