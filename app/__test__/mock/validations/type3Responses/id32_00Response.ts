/*
In >= 1 detail record, reason code 5 or reason code 9 has been entered and the figure entered in 
the Pensionable Earnings field is > £0


*/

export const id32_00Response = {
  dataHeaderRow: {
  ...
  dataDetailRows: [
    {
      membContribDetlId: "xa11sdsdsdsdsddssdddsd",
