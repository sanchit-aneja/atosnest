/*
In >= 1 detail record, reason code 7 has been entered and the date entered in the Effective Date of Group
 Change field is more than 1 day after the EPED of the CS the member is currently in (ie. if EPED is 31/01,
  the 01/02 is accepted but 02/02 isn't accepted)

*/

export const id31_55Response = {
  dataHeaderRow: {
    contribHeaderId: "3419f2bddb-5516-4871-b1fd-8773503d",
