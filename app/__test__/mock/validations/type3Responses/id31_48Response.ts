/*
In >= 1 detail record, reason code 6 or reason code 12 has been entered and the name entered in the New Payment
 Source Name field is the same payment source that the member is currently in (payment source is case sensitive)

*/

export const id31_48Response = {
  dataHeaderRow: {
    contribHeaderId: "3419f2bb-51-b1fd-8595773503d",
