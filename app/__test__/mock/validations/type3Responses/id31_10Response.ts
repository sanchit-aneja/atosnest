/*
In >= 1 detail record, reason code 10 has been entered without the Employer Contributions for Second 
Enrolment field being provided
*/
export const id31_10Response = {
  dataHeaderRow: {
