/*
In >= 1 detail record, no reason code has been entered but the fields for
 New Group Name and Notice to Opt-Out Reference Number have been completed

*/

export const id33_02Response = {
  dataHeaderRow: {
  ...
  dataDetailRows: [
    {
      membContribDetlId: "x12a11sds333dsdsdsddssdddsd",
