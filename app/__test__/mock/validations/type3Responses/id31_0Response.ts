/*
In >= 1 detail record, reason code 6 or reason code 12 has been entered without the Effective Date of Partial 
or Non-Payment of Contributions field being provided
*/
export const id31_0Response = {
  dataHeaderRow: {
