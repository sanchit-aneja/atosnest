/*
In >= 1 detail record, no reason code has been entered but the fields for New Payment 
Source name and Notice to Opt-Out Reference Number have been completed

*/

export const id33_00Response = {
  dataHeaderRow: {
  ...
  dataDetailRows: [
    {
      membContribDetlId: "x11a11sds333dsdsdsddssdddsd",
