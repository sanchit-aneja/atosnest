export const eligibleContributionDetailsSearchSuccessResponse = {
  totalRecordCount: 10,
  results: [
    {
...
export const eligibleContributionDetailsSearchInvalid404Response = {
  type: "",
  instance: "",
  errors: [
    {
...
export const eligibleContributionDetailsSearchInvalid500response = {
