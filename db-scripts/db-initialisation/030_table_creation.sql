...
CREATE TABLE IF NOT EXISTS contribution_index_schema."Error_Details"
  ( 
    ...
    CONSTRAINT R_48 FOREIGN KEY (Error_Type_Id) REFERENCES contribution_index_schema."RD_Error_Type"(Error_Type_Id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS contribution_index_schema."Contribution_Header_Submission"
    ...
    Interim_Payment_Method VARCHAR (2) NULL,
...
CREATE TABLE IF NOT EXISTS contribution_index_schema."Stg_File_Member_Details"
  ( 
	...
	File_Schedule_Member_Id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	Record_Start_Date DATE NULL,
	Record_End_Date DATE NULL,
	Created_By VARCHAR(50) NULL,
...
CREATE TABLE IF NOT EXISTS contribution_index_schema."RD_Error_Type"
  ( 
	Error_Number VARCHAR (20) NOT NULL,
	Error_Type VARCHAR (2) NULL,
	Process_Type VARCHAR (10) NOT NULL,
	Online_Error_Message_Txt VARCHAR (2500) NULL,
	Detailed_Error_Message_Txt VARCHAR (2500) NULL,
	Error_Type_Id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
